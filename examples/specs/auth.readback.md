...
> Auto-generated by `tools/spec-readback.py` from `specs/auth.json`. Do not edit; regenerate after spec changes.
...
_Approval lives in PR history — audit trail: `git log --follow specs/auth.json`_
