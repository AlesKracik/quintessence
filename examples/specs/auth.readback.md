...
**⚠ NOT READY** — 4 of 4 requirement(s) not verified against code; 3 of 3 invariant(s) not holding; 3 open question(s).

**Status:** formalized  |  **Requirements:** 0/4 verified, 1/4 witnessed  |  **Invariants:** 0 proven + 0 bounded / 3  |  **Coverage:** 13 cells, 4 covered, 9 triaged, 0 untriaged  |  **Open questions:** 3  |  **Last verified:** never
